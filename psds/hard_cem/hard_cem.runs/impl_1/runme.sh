...
HD_PWD='C:/Users/L340/Desktop/PSDS_projekat/hard_cem/hard_cem.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cumulative_energy_map.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cumulative_energy_map.tcl -notrace
