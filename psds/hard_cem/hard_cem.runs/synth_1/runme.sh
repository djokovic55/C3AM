...
HD_PWD='C:/Users/L340/Desktop/PSDS_projekat/hard_cem/hard_cem.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cumulative_energy_map.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cumulative_energy_map.tcl
